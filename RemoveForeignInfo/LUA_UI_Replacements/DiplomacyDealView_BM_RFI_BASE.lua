...
-- DB [not sure this is needed...]		2021-03-12: line 714
--			if (iNewAmount) then
...
-- DB		2021-03-12: line 1187
		if GameConfiguration.GetValue("BM_REMOVE_FOREIGN_INFO") and (not ms_OtherPlayerIsHuman and not DealIsEmpty() and not bDealValid) then		-- if (not DealIsEmpty() and not bDealValid) then
-- /DB
...
-- DB		2021-03-12: line 1354 (this edit isn't in XP2)
						if GameConfiguration.GetValue("BM_REMOVE_FOREIGN_INFO") and player:GetID() ~= ms_OtherPlayerID then
							addAmount = clip(addAmount, nil, pDealItem:GetMaxAmount());
						end
-- /DB
...
-- DB		2021-03-12: line 1779
					if GameConfiguration.GetValue("BM_REMOVE_FOREIGN_INFO") then
						uiIcon.AmountText:SetHide(true);	-- uiIcon.AmountText:SetHide(false);
					end
-- /DB
					uiIcon.RemoveButton:SetHide(true);
					uiIcon.StopAskingButton:SetHide(true);
