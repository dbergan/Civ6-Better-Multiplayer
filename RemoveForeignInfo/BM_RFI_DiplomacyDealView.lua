...
-- DB
		if (ms_OtherPlayerIsHuman and DealDirection.OUTGOING) then
			bDealValid = true;
		end
-- /DB
...
-- DB			
					if (player:GetID() ~= ms_OtherPlayerID) then
...
-- DB
		if (not ms_OtherPlayerIsHuman and not DealIsEmpty() and not bDealValid) then		-- if (not DealIsEmpty() and not bDealValid) then
-- /DB
...
-- DB
			if (pDealItem:GetFromPlayerID() == g_LocalPlayer:GetID()) then
