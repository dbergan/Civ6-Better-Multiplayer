...
-- DB - don't add other players' progress toward great people to the panel [BM: Remove Foreign Info]
			elseif not GameConfiguration.GetValue("BM_REMOVE_FOREIGN_INFO") then
-- /DB
...
-- DB - this wildcard include must be disabled to stop an infinite regression
