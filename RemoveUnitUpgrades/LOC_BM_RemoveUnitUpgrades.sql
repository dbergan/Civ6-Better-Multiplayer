...
UPDATE LocalizedText SET Text = REPLACE(REPLACE(Text, '1%', '4%{LOC_MOD_LABEL}'), '20%', '80%{LOC_MOD_LABEL}') WHERE Tag IN
('LOC_GOVT_ACCUMULATED_BONUS_OLIGARCHY',
'LOC_GOVT_ACCUMULATED_BONUS_BRIEF_OLIGARCHY_XP1') ;
*/

UPDATE LocalizedText SET Text = REPLACE(Text, '+10%', '+40%{LOC_MOD_LABEL}') WHERE Tag IN
('LOC_TRAIT_CIVILIZATION_MAPUCHE_TOQUI_DESCRIPTION',
'LOC_ABILITY_TOQUI_XP_FROM_GOVERNOR_DESCRIPTION') ;

UPDATE LocalizedText SET Text = REPLACE(Text, '+30%', '+120%{LOC_MOD_LABEL}') WHERE Tag = 'LOC_ABILITY_TOQUI_XP_FROM_GOVERNOR_NOT_FOUNDED_DESCRIPTION' ;

UPDATE LocalizedText SET Text = REPLACE(Text, '+25%', '+100%{LOC_MOD_LABEL}') WHERE Tag IN
...
'LOC_SDG_SWORD_OF_GIDEON_DESCRIPTION',
'LOC_SDG_ABILITY_SWORD_OF_GIDEON_DESCRIPTION') ;

UPDATE LocalizedText SET Text = REPLACE(Text, '+25%', '+50%') WHERE Tag = 'LOC_POLICY_AFTER_ACTION_REPORTS_DESCRIPTION' ; -- original says 25% when the modifier actually does 50%
UPDATE LocalizedText SET Text = REPLACE(Text, '+50%', '+200%{LOC_MOD_LABEL}') WHERE Tag IN
...
UPDATE LocalizedText SET Text = REPLACE(Text, '+100%', '+400%{LOC_MOD_LABEL}') WHERE Tag IN
...
UPDATE LocalizedText SET Text = REPLACE(Text, '+25%', '+200%{LOC_MOD_LABEL}') WHERE Tag IN
...
UPDATE LocalizedText SET Text = REPLACE(Text, '+75%', '+200%{LOC_MOD_LABEL}') WHERE Tag IN
...
UPDATE LocalizedText SET Text = REPLACE(Text, '+100%', '+200%{LOC_MOD_LABEL}') WHERE Tag IN
...
UPDATE LocalizedText SET Text = REPLACE(Text, '+200%', '+200%{LOC_MOD_LABEL}') WHERE Tag IN
('LOC_GREATPERSON_CLANCY_FERNANDO_ACTIVE',
'LOC_ABILITY_CLANCY_FERNANDO_BONUS_EXPERIENCE_DESCRIPTION') ;
*/
