...
BM_AttackerRGB = "255,47,47"
BM_DefenderRGB = "36,119,255"
-- ---------------------------------------------
...
function BM_Combat_Summary(CombatResult)
	...
	local a = "[COLOR:" .. BM_AttackerRGB .. ",255]"
...
function BM_AttackerDetails(CombatResult)	
	local a = "[COLOR:" .. BM_AttackerRGB .. ",255]"
	a = a .. BM_CombatantLongName(CombatResult, CombatResultParameters.ATTACKER) .. " "
...
function BM_DefenderDetails(CombatResult)
	local a = "[COLOR:" .. BM_DefenderRGB .. ",255]"
	a = a .. BM_CombatantLongName(CombatResult, CombatResultParameters.DEFENDER) .. " "
